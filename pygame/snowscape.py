...
def main():
    ...
    # for i in range(MAX_SNOW):
    #     snow = Snow()
    #     small_snow_list.append(snow)
    #
    # medium_snow_list = []
    # for i in range(MAX_SNOW):
    #     snow = Snow(3)
    #     snow.y_vel = random.randrange(2, 4)
    #     medium_snow_list.append(snow)
    #
    # large_snow_list = []
    # for i in range(MAX_SNOW):
    #     snow = Snow(4)
    #     snow.y_vel = random.randrange(3, 5)
    #     large_snow_list.append(snow)
    ...
    while not done:
        ...
        # for snow in small_snow_list:
        #     snow.update()
        #
        # for snow in medium_snow_list:
        #     snow.update()
        #
        # for snow in large_snow_list:
        #     snow.update()
